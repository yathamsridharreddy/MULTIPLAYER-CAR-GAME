/* ============================================================================
   ...
   ========================================================================== */
const CACHE = 'sridhar-rush-v100';

const CORE = [
  '/', '/controller',
  '/css/style.css?v=100', '/css/controller.css?v=100',
  '/js/game-core.js?v=100', '/js/progression.js?v=100', '/js/cosmetics.js?v=100', '/js/net.js?v=100', '/js/game.js?v=100', '/js/controller.js?v=100', '/js/account.js?v=100', '/js/i18n.js?v=100',
  ...
  '/manifest.webmanifest', '/manifest-controller.webmanifest', '/replay', '/js/replay.js?v=100',
